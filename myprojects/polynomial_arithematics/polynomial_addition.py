...
class poly_sum_ex1(Scene):
    def construct(self):
        ...
        framebox7 = SurroundingRectangle(eq1[0:5], buff = .1)
        framebox8 = SurroundingRectangle(eq1[6:11], buff = .1, color = BLUE)
        framebox9 = SurroundingRectangle(eq1[12:], buff = .1, color = RED)
        ...
        self.play(ShowCreationThenFadeOut(framebox7))
        self.play(ReplacementTransform(eq1[0:5].copy(), eq2[0:6]))
        self.wait(1)

        self.play(Write(eq2[6]))
        self.play(ShowCreationThenFadeOut(framebox8))
        self.play(ReplacementTransform(eq1[6:11].copy(), eq2[7:13]))
        self.wait(1)

        self.play(ShowCreationThenFadeOut(framebox9))
        self.play(Write(eq2[13]))
        self.play(ReplacementTransform(eq1[12:].copy(), eq2[14:]))
        self.wait(1)
        '''
        # scene 3: equation 3
        '''
        ...
        self.wait(0.5)
        self.play(ReplacementTransform(eq3[0:2].copy(), eq4[0:2]))
        self.wait(0.5)
        self.play(ReplacementTransform(eq3[2:5].copy(), eq4[2:4]))
        self.wait(0.5)
        self.play(ReplacementTransform(eq3[5:].copy(), eq4[4:]))
        self.wait(0.5)
