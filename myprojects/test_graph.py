...
class TwoD(GraphScene):
    ...
    def construct(self):
        ...
        self.add(point)
        self.play(ShowCreation(self.area))
        self.wait(2)
...
class para(GraphScene):
    ...
    def construct(self):
        ...
        x.add_updater(lambda v: v.set_value(math.cos(theta.get_value())))
        y.add_updater(lambda v: v.set_value(math.sin(theta.get_value())))
